...
def generate_b50_image(data: dict) -> Image.Image:
    ...
    draw.text((mx + CARD_WIDTH - 8,  my + 4), "SDVX-B50-Bot", font=font(9), fill=GRAY, anchor="ra")
    ...
    # ── Footnote ──────────────────────────────────────────────────────────────
    draw.text(
        (IMAGE_WIDTH - GRID_MARGIN, IMAGE_HEIGHT - FOOTER_HEIGHT // 2 + 1),
        "Generated by SDVX-B50#0637",
        font=font(10),
        fill=GRAY,
        anchor="rm",
    )
